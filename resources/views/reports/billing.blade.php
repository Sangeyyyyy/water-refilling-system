...
<head>
    ...
    <title>Billing Statement #{{ $order->id }}</title>
    <style>
        @page {
            size: A4;
            margin: 0;
...
<body>
    <div class="no-print" style="text-align: center; margin: 20px 0;">
        <button onclick="window.print()" style="padding: 10px 20px; font-size: 16px; cursor: pointer; background: #1e4d2b; color: white; border: none; border-radius: 5px;">Print Billing Statement</button>
    </div>
